...
Update is allowed to have zero quantity because the future order-book phase
will interpret that as level removal.
...
Normalized features and model values will use signed Q16.16 numbers: real value
